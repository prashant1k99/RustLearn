fn main() {
    ...
    // Rust code uses snale case as the conventional pstyle of funciton and variable names, in
...
fn statement_and_expressions() {
    ...
    // That value gets bound to `y` as part of the let statement. Note that hte `x + 1` line
