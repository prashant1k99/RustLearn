fn main() {
    ...
    // third approach: memory is managed through a system of ownership with a set of rules that
    // the compiler checks. If any of the rules are violated, the program won't compile. None of
